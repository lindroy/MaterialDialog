...
import com.lindroy.materialdialog.util.screenWidth
...
internal class BottomMenuDialog : BaseBottomDialog() {
    ...
    companion object {
        internal fun showListDialog(params: BottomListParams, fm: androidx.fragment.app.FragmentManager, tag: String) =
            BottomMenuDialog().apply {
                listParams = params
                show(fm, tag)
            }

        internal fun showGridDialog(builder: BottomGridBuilder, fm: androidx.fragment.app.FragmentManager, tag: String) =
            BottomMenuDialog().apply {
                gridParams = builder
                show(fm, tag)
            }
